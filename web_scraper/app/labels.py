...
skill_div_xpath = './/div[@class="flex items-center"]'
skills_xpath = './/div[@class="truncate py-[2px]"]'

href_job_xpath = './/a[@class="after:absolute after:inset-0"]/'

###
ads_fullscreen_xpath = '//div[@class="mb-4 relative flex flex-col lg:flex-row items-stretch rounded-lg max-full bg-white overflow-hidden cursor-pointer shadow hover:shadow-md"]'
